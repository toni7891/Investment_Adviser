...
resource "aws_security_group" "app" {
  ...
  description = "4RCH3R Investment Terminal app traffic"
  vpc_id      = aws_vpc.main.id

  ingress {
    description = "SSH — restrict ssh_allowed_cidr to your IP in production"
    from_port   = 22
    to_port     = 22
    protocol    = "tcp"
